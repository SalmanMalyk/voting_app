										...
										<div id="side-sortables" class="accordion-container">
											<ul class="outer-border">
												<li class="control-section accordion-section  open add-page" id="add-page">
													<h3 class="accordion-section-title hndle" tabindex="0"> Menu Item <span class="screen-reader-text">Press return or enter to expand</span></h3>
														...
														<div class="inside">
															<div class="customlinkdiv" id="customlinkdiv">
																<div class="form-row">
																	...
																	<div class="col-md-12">
																		<div class="form-group row">
																	        <label for="custom-menu-item-name" class="col-sm-2 col-form-label">Title:</label>
																	        <div class="col-sm-10">
																	            <input type="text" class="form-control" id="custom-menu-item-name" placeholder="Enter menu item name" name="label" required>
																	        </div>
																	    </div>
																	</div>
																	{{-- URL --}}
																	<div class="col-md-12">
																		<div class="form-group row">
																	        <label for="custom-menu-item-url" class="col-sm-2 col-form-label">URL:</label>
																	        <div class="col-sm-10">
																	            <input type="text" class="form-control" id="custom-menu-item-url" placeholder="Enter route name / url" name="url" required>
																	        </div>
																	    </div>
																	</div>
																	...
																	@if(!empty($roles))
																		<div class="col-md-12">
																			<div class="form-group row">
																		        <label for="custom-menu-item-role" class="col-sm-2 col-form-label">Role:</label>
																		        <div class="col-sm-10">
																		            <select id="custom-menu-item-role" class="form-control" name="role">
																...
																<p class="button-controls">
																	<a  href="#" onclick="addcustommenu()"  class="button-secondary submit-add-to-menu right">
																		<i class="fa fa-plus fa-fw"></i> Add menu item
																	</a>
															...
															<li id="menu-item-{{$m->id}}" class="menu-item menu-item-depth-{{$m->depth}} menu-item-page menu-item-edit-inactive pending" style="display: list-item;">
																<dl class="menu-item-bar">
																	<dt class="menu-item-handle">
																		<span class="item-title float-left"> <span class="menu-item-title"> <span id="menutitletemp_{{$m->id}}">{{$m->label}}</span> <span style="color: transparent;">|{{$m->id}}|</span> </span> <span class="is-submenu" style="@if($m->depth==0)display: none;@endif">Subelement</span> </span>
																...
																<div class="menu-item-settings" id="menu-item-settings-{{$m->id}}">
																	...
																	<div class="form-row mt-2">
																		...
																		<div class="col-12 mb-2 row">
																	        <label for="idlabelmenu_{{$m->id}}" class="col-sm-2 col-form-label">Title:</label>
																	        <div class="col-sm-10">
																	            <input type="text" class="form-control edit-menu-item-title" id="idlabelmenu_{{$m->id}}" placeholder="Enter menu item name" name="idlabelmenu_{{$m->id}}" value="{{$m->label}}" required>
																	        </div>
																	    </div>
																	    {{-- URL --}}
																	    <div class="col-12 mb-2 row">
																	        <label for="url_menu_{{$m->id}}" class="col-sm-2 col-form-label">Url:</label>
																	        <div class="col-sm-10">
																	            <input type="text" class="form-control edit-menu-item-url" id="url_menu_{{$m->id}}" placeholder="Enter route name / url" name="url_menu_{{$m->id}}" value="{{$m->link}}" required>
																	        </div>
																	    </div>
																	    {{-- Custom CSS --}}
																	    <div class="col-12 mb-2 row">
																	        <label for="clases_menu_{{$m->id}}" class="col-sm-2 col-form-label">Class:</label>
																	        <div class="col-sm-10">
																	            <input type="text" class="form-control edit-menu-item-classes" id="clases_menu_{{$m->id}}" placeholder="Enter class (optional)" name="clases_menu_{{$m->id}}" value="{{$m->class}}">
																	        </div>
																		</div>

																		{{-- Status --}}
																	    <div class="col-12 mb-2 row">
																	        <label for="status_menu_{{$m->id}}" class="col-sm-2 col-form-label">Status:</label>
																	        <div class="col-sm-1 mt-2">
																	            <input type="checkbox" class="form-control edit-menu-item-statuses" id="status_menu_{{$m->id}}" name="status_menu_{{$m->id}}" {{ $m->status ? 'checked' : null }}>
																	        </div>
																		</div>
																	    ...
																	    @if(!empty($roles))
																			<div class="col-12 form-group row">
																		        <label for="role_menu_{{$m->id}}" class="col-sm-2 col-form-label">Role:</label>
																		        <div class="col-sm-10">
																		            <select name="role_menu_[{{$m->id}}]" class="form-control edit-menu-item-role" id="role_menu_{{$m->id}}">
																		...
																		<div class="col-md-12 text-left">
																			<p class="hide-if-no-js">
																				<span class="font-weight-bold mr-1">Move:</span> 
