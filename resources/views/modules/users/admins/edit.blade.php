<x-saga.modal target="editModal" modalType="lg">
    ...
    >
        ...
        <div class="form-row">
            ...
            <div class="mb-2 col-md-12">
                <div class="clearfix">
                    <label for="edit_role_id" class="font-size-sm mb-1 float-left">Select Role:<span class="text-danger">*</span></label>
                ...
                <x-saga.select2 name="role_id" id="edit_role_id" route="api.getRoleName" />
            </div>

            <hr class="w-100" />
            
            <div class="mb-2 col-md-6" x-id="['password']">
                <label :for="$id('password')" class="font-size-sm mb-1">Password:</label>
            ...
            <div class="mb-2 col-md-6" x-id="['password_confirmation']">
                <label :for="$id('password_confirmation')" class="font-size-sm mb-1">Confirm Password:</label>
    ...
    <x-slot name="footer">
        <button type="submit" class="btn btn-primary btn-sm rounded-0" form="editForm"><i
                class="fas fa-cloud-upload mr-1"></i>
            Update Admin</button>
    </x-slot>
