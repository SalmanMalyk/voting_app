...
')
    ...
    namespace App\Facade\Outreach { 
            /**
     * 
     *
     */ 
        class OutreachFacade {
                    /**
         * Send message directly
         *
         * @param int $number mobile number of person
         * @param string $message message body
         * @return \App\Facade\Outreach\json response from api
         * @static 
         */ 
        public static function send($number, $message)
        {
                        return \App\Facade\Outreach\Outreach::send($number, $message);
        }
                    /**
         * 
         *
         * @static 
         */ 
        public static function sendNow($customerBranch, $messageType)
        {
                        return \App\Facade\Outreach\Outreach::sendNow($customerBranch, $messageType);
        }
                    /**
         * 
         *
         * @static 
         */ 
        public static function bulkSend($customer_branch_ids, $message)
        {
                        return \App\Facade\Outreach\Outreach::bulkSend($customer_branch_ids, $message);
        }
                    /**
         * 
         *
         * @static 
         */ 
        public static function customer($customerBranch, $message, $type = null)
        {
                        return \App\Facade\Outreach\Outreach::customer($customerBranch, $message, $type);
        }
...
namespace  { 
            ...
            class Outreach extends \App\Facade\Outreach\OutreachFacade {}
